...
is translated an an internal "Abstract Syntax Tree" (AST)
...
.. graphviz::
    ...
    digraph foo {
        ...
        OutputRenderer -> XMLSchemaRenderer [dir=back arrowtail=empty]
        OutputRenderer -> ListStoredQueriesRenderer [dir=back arrowtail=empty]
        OutputRenderer -> DescribeStoredQueriesRenderer [dir=back arrowtail=empty]
